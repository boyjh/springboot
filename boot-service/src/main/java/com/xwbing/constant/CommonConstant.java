...
public class CommonConstant {
     ...
     * 中国各省市
     */
    public static final String CHINA = "北京,天津,河北,山西,内蒙古,辽宁,吉林,黑龙江,上海,江苏,安徽,福建,江西,山东,河南,湖北,湖南,广东,广西,海南,重庆,四川,贵州,云南,西藏,陕西,甘肃,青海,宁夏,新疆,台湾,香港,澳门";
    /**
     * 浙江各市
     */
    public static final String ZHEJIANG = "杭州,宁波,温州,绍兴,湖州,嘉兴,金华,衢州,台州,丽水,舟山";
}
